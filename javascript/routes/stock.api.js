...
const holding_stock_1 = require("../model/holding-stock");
    ...
    getHoldingStocks(req, res, next) {
        ...
        for (var i = 0; i < trades.length; i++) {
            ...
            if (existing != null) {
                ...
                var holding = holding_stock_1.HoldingStock.create(trade.code, trade.units - trade.soldUnits, trade.price, trade.netAmount * (trade.units - trade.soldUnits) / trade.units);
        ...
        async.each(holdingStocks, function (t, callback) {
